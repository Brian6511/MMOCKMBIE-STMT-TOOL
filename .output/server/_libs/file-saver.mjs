...
var require_FileSaver_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	(function(a, b) {
		...
		var f = "object" == typeof window && window.window === window ? window : "object" == typeof self && self.self === self ? self : "object" == typeof globalthis_default && globalthis_default.global === globalthis_default ? globalthis_default : void 0, a = f.navigator && /Macintosh/.test(navigator.userAgent) && /AppleWebKit/.test(navigator.userAgent) && !/Safari/.test(navigator.userAgent), g = f.saveAs || ("object" != typeof window || window !== f ? function() {} : "download" in HTMLAnchorElement.prototype && !a ? function(b, g, h) {
